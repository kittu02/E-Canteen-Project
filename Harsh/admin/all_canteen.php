																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				$mql="SELECT * FROM res_category where c_id='".$rows['c_id']."'";
																					...
																					echo ' <tr><td>'.$row['c_name'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
																									 <td><a href="delete_canteen.php?res_del='.$rows['rs_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_canteen.php?res_upd='.$rows['rs_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';
